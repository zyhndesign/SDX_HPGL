var colorMgr=(function(config,functions){
    function remove(id,pId){
        functions.showLoading();
        var me=this;
        $.ajax({
            url:config.ajaxUrls.colorDelete.replace(":id",id),
            type:"post",
            data:{
                parentId:pId,
                id:id
            ...
            success:function(response){
                if(response.success){
                    ...
                    if(treeNode.check_Child_State!=-1){
                        zTree.addNodes(treeNode, {id:response.object, pId:treeNode.id, name:"新颜色" +no,isParent:true});
                    }else{
    ...
    function rename(id,pId,name){
        ...
        var me=this;
        $.ajax({
            url:config.ajaxUrls.colorUpdate,
            type:"post",
            data:{
                name:name,
                parentId:pId,
...
$(document).ready(function(){
    ...
    $.fn.zTree.init($("#treeDemo"), colorMgr.setting);
