...
public class SizeDaoImpl implements SizeDao {
	...
	public long insertSizeData(String key, String value) {
		...
		return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				...
				connection.hSet(ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + key),
						ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + id), ser.serialize(value));
	...
	public void updateSizeData(String parentKey, String key, String value) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				RedisSerializer<String> ser = redisTemplate.getStringSerializer();
				connection.hSet(ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + parentKey),
						ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + key), ser.serialize(value));
				return null;
			}
		});
	}
	...
	public void deleteSizeData(String parentKey, String key) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				RedisSerializer<String> ser = redisTemplate.getStringSerializer();
				connection.hDel(ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + parentKey),
						ser.serialize(RedisVariableUtil.SIZE_PREFIX + RedisVariableUtil.DIVISION_CHAR + key));
				return null;
			}
		});
	}
