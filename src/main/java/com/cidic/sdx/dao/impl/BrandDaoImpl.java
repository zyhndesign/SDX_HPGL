...
public class BrandDaoImpl implements BrandDao {
	...
	public long insertBrandData(String key, String value) {
		...
		return redisTemplate.execute(new RedisCallback<Long>() {
			...
			public Long doInRedis(RedisConnection connection) throws DataAccessException {
				...
				connection.hSet(ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + key),
						ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + id), ser.serialize(value));
	...
	public void updateBrandData(String parentKey, String key, String value) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				RedisSerializer<String> ser = redisTemplate.getStringSerializer();
				connection.hSet(ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + parentKey),
						ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + key), ser.serialize(value));
				return null;
			}
		});
	...
	public void deleteBrandData(String parentKey, String key) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				RedisSerializer<String> ser = redisTemplate.getStringSerializer();
				connection.hDel(ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + parentKey),
						ser.serialize(RedisVariableUtil.BOARD_PREFIX + "." + key));
				return null;
			}
		});
